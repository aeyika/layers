...
export default function Hero() {
    ...
    return( 
    <section className="py-24 overflow-x-clip" style={{ cursor: `url(${cursorYouImage.src}) 0 0, auto` }}>
            <div className="container relative">
                ...
                className="absolute -left-32 top-16 hidden lg:block"
                 >
                    <Image src={designExample1Image} alt="Design Example" draggable="false" />
                </motion.div>
                ...
                className="absolute -right-64 -top-16 hidden lg:block">
                    <Image src={designExample2Image} alt="Design Example" draggable="false" />
                </motion.div>
                ...
                <div className="flex justify-center">
                    <div className="inline-flex py-1 px-3 bg-gradient-to-r from-purple-400 to-pink-400 rounded-full text-neutral-950 font-semibold">
                        ✨ $15K seed round raised
                    </div>
                </div>
                    <h1 className="text-6xl md:text-7xl lg:text-8xl font-medium text-center mt-6">Impactful design, created <span className="font-serif italic">effortlessly</span></h1>
