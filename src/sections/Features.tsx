        ...
        <section className="py-24">
            <div className="container">
                ...
                <div className="mt-12 grid grid-cols-1 md:grid-cols-4 gap-8 lg:grid-cols-3">
                    ...
                    <FeatureCard
                        ...
                        description="Engage your clients with prototypes that react to user actions.">
                            <div className="aspect-video flex items-center justify-center">
                                <p className="text-4xl font-extrabold text-white/20 text-center">We&apos;ve achieved{" "} <span className="bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent block">incredible</span>{" "} growth this year</p>
                            </div>
                    </FeatureCard>
                    <FeatureCard 
                ...
                {features.map(feature => (
                    <div key={feature} className="bg-neutral-900 border border-white/10 inline-flex px-3 py-1.5 rounded-2xl gap-3 items-center md:py-2">
